...
while ($name = mysqli_fetch_assoc($result)) {
  array_push($array, [$name['src'], $name['title']]);
}
  ...
  <main class="container">
    ...
    <div class="album">
        ...
        <div class="album-container">
          <img src=<?php echo $src1 ?> title=<?php echo $title1 ?>>
          <div>
            <p>
      ...
      <div class="album">
        ...
        <div class="album-container">
          <img src=<?php echo $src2 ?> title=<?php echo $title2 ?>>
          <div>
            <p>
      ...
      <div class="album">
        ...
        <div class="album-container">
          <img src=<?php echo $src3 ?> title=<?php echo $title3 ?>>
          <div>
            <p>
      ...
      <div class="album">
        ...
        <div class="album-container">
          <img src=<?php echo $src4 ?> title=<?php echo $title4 ?>>
          <div>
            <p>
